 ...
 * @author zidah
 */
public class ChartsFormPositionVA extends javax.swing.JInternalFrame {
private static final ChartsFormPositionVA instane =new ChartsFormPositionVA();
private TrackerService ts;
 private vehiculeService vs;
    /**
     * Creates new form ChartsForm
     */
    private ChartsFormPositionVA() {
        initComponents();
 ...
 public static final ChartsFormPositionVA getInstance() {
  		return instane ;
  	}
...
DefaultCategoryDataset dod = new DefaultCategoryDataset();
 private void countpPosition( ){
     ...
     dod.setValue(count, "nombre de positions ",year1);
